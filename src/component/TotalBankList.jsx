...
import { Getbankbalance } from '../store/slices/client';
...
const Item = () => {
  ...
  const [columns, setcolumns] = useState([
    ...
    { header: 'Total Bank Balance', field: 'bank_balance' },
  ]);
  ...
  useEffect(() => {
    setIsLoading(true);
    dispatch(Getbankbalance({ partner_id: id }))
      .unwrap()
      .then((data) => {
        setIsLoading(false);
            ...
            <div className="row content-body">
              <div className="container-fluid">
                <div className="page-header">
                  <div>
                    <h2 className="main-content-title tx-24 mg-b-5">Total Bank Balance List</h2>
                    <ol className="breadcrumb">
                      <li className="breadcrumb-item">
                        <a href="#">Bank</a>
                      </li>
                      <li className="breadcrumb-item active" aria-current="page">
                        Total Bank Balance List
                      </li>
                    </ol>
                  </div>
                </div>
